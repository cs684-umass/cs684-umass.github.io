...
Credits & 3 \\
Date & (Mon/Wed 2:30 PM--3:45 PM) \\
Delivery Mode & In-person (Computer Science Building, Room 142) \\
...
\begin{itemize}
  ...
  \item Pre-requisites:
  \begin{itemize}
    \item You need to operate on synthetic customer data (users, companies).
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Other resources: NeurIPS posters \link{https://drive.google.com/drive/u/1/folders/16tSJGJryd7NgQCBblaKxTfXLZXDIJJrt}{example}, and \link{https://github.com/zhoubolei/bolei_awesome_posters}{Bolei poster repo}.
  \end{itemize}
...
We are using the scale from Senate Doc \link{https://www.umass.edu/senate/book/courses-policies-syllabus}{\textbf{24-066}} 
...
\midrule
At least 93 & \textbf{A} \\
At least 90 but less than 93 & \textbf{A} \\
At least 87 but less than 90 & \textbf{B+} \\
At least 83 but less than 87 & \textbf{B} \\
At least 80 but less than 83 & \textbf{B-} \\
At least 77 but less than 80 & \textbf{C+} \\
At least 73 but less than 77 & \textbf{C} \\
Less than 73 & \textbf{F} \\
\bottomrule
\end{tabular}
\end{center}
...
Reference: \link{https://www.umass.edu/diversity/about/land-acknowledgement}{Land Acknowledgment}. 

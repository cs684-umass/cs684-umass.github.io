...
University policies regarding \textbf{Accommodations}, \textbf{Academic Integrity}, and \textbf{Title IX} apply to all courses. The required statements are provided below. These statements are also maintained by the Faculty Senate at: \link{https://www.umass.edu/senate/book/non-responsible-employee-required-syllabus-statements}{required syllabus statements}.\footnote{That page indicates that the instructor for this course is not a ``responsible employee'' for Title IX reporting purposes.}

\subsection*{Academic Integrity (Course-Specific Expectations)}
...
\section*{Additional Recommended Statements (Guidelines)}
